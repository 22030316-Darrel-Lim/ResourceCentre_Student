...
public class ResourceCentreTest {
	...
	public void setUp() throws Exception {
		...
		cb2 = new Chromebook("CB0012", "SAMSUNG Chromebook", "Win 10");
	...
	public void testRetrieveAllChromebook() {
		...
		String testOutput = "";
		// Test if the output is empty
		assertEquals("Test that nothing is displayed", testOutput, allChromebooks);
		...
		testOutput = String.format("%-10s %-30s %-10s %-10s %-20s\n", "CB0011", "My Google Chromebook 1st", "Yes", "",
				"Mac OS");
		testOutput += String.format("%-10s %-30s %-10s %-10s %-20s\n", "CB0012", "SAMSUNG Chromebook", "Yes", "",
				"Win 10");
		// Test that the details are displayed correctly
		assertEquals("Test that the display is correct.", testOutput, allChromebooks);
